...
<body class="login_body">
	...
	<div class="login_div">
		...
		<form action="${pageContext.request.contextPath }/login.action" class="login" method="post">
			<div class="nav">
	...
	<div class="register_body">
		...
		<form action="${pageContext.request.contextPath }/register.action" class="register" method="post">
			<div class="nav">
				<div class="nav register_nav">
					<div class="col-xs-4">用户名:</div>
					<div class="col-xs-6">
						<input type="text" name="username" id="name_r"
							placeholder="&nbsp;&nbsp;用户名/手机号"
				...
				<div class="nav register_affirm">
					...
					<div class="col-xs-6">
						<input type="password" name="password" id="affirm_psd" value=""
							placeholder="&nbsp;&nbsp;确认密码"
							onBlur="javascript:ok_or_errorByRegister(this)" />
					</div>
					<div class="col-xs-1 ok_gou">√</div>
